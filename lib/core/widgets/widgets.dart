...
class Widgets {
  ...
  static Padding textFormField(BuildContext context, String err,
  ...
  static void copy(String passwprd, BuildContext context) {
    Clipboard.setData(ClipboardData(text: passwprd)).then((_) {
